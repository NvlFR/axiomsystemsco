      ...
      <div className="max-w-[1200px] mx-auto space-y-24 relative z-10">
        ...
        <div className="text-center space-y-6 max-w-2xl mx-auto">
          ...
          <p className="text-xl text-zinc-400 leading-relaxed">
            We treat automation like software engineering. Structured, scalable,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                ...
                <div
                  className={cn(
                    "absolute top-[200px] w-full bg-[#18181b] border border-white/10 rounded-xl p-4 text-left transition-all duration-300 pointer-events-none opacity-0 translate-y-4 shadow-xl",
